        ...
        <form method="POST" action="{{ route('projects.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('name') }}" required>
                @error('name')
            ...
            <div>
                ...
                <a href="{{ route('projects.index') }}" class="ml-4 text-gray-600 underline">Cancel</a>
            </div>
        </form>
    </div>
</x-app-layout>
